...
{
       0,     0,     3,     7,     9,    12,    17,    23,    29,    33,
      35,    39,    41,    45,    47,    51,    55,    59,    61,    63
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      19,     0,    -1,     4,    20,     5,    -1,    21,    -1,    20,
      21,    -1,     9,    15,    24,     8,    -1,     6,    16,    22,
      17,     8,    -1,     7,    16,    23,    17,     8,    -1,     7,
       9,     8,    -1,     9,    -1,    22,    13,     9,    -1,    24,
      -1,    23,    13,    24,    -1,    25,    -1,    24,    11,    25,
      -1,    24,    12,    25,    -1,    24,    14,    24,    -1,     9,
      -1,    10,    -1,    16,    24,    17,    -1
};
...
{
       0,    47,    47,    51,    52,    56,    57,    58,    59,    64,
      65,    69,    70,    74,    75,    76,    77,    81,    82,    83
};
#endif
...
{
  "$end", "error", "$undefined", "FDT", "INICIO", "FIN", "LEER",
  "ESCRIBIR", "PUNTOYCOMA", "ID", "CONSTANTE", "'+'", "'-'", "','", "'*'",
  "ASIGNACION", "'('", "')'", "$accept", "programa", "listaSentencias",
...
{
       0,     0,     0,     0,     0,     0,     0,     3,     1,     0,
       0,     0,     0,     2,     4,     9,     0,     8,    17,    18,
       0,     0,    11,    13,     0,     0,     0,     0,     0,     0,
       0,     0,     0,     5,    10,     6,    19,    12,     7,    14,
      15,    16
};
...
{
       3,    28,     1,    -4,    -5,     9,    24,   -26,   -26,    17,
      19,    -7,    -7,   -26,   -26,   -26,    -3,   -26,   -26,   -26,
      -7,     0,    27,   -26,     7,    23,    32,    11,    -7,    34,
      -7,    -7,    -7,   -26,   -26,   -26,   -26,    27,   -26,   -26,
     -26,   -26
};
...
{
      24,     8,    18,    19,    10,    39,    40,     1,    27,    20,
      25,    11,     9,    28,    26,    33,    37,    29,    30,    31,
      41,    32,    30,    31,    12,    32,    15,    17,    36,    13,
       3,     4,    34,     5,     3,     4,    14,     5,    30,    31,
      35,    32,    38
};

static const yytype_uint8 yycheck[] =
{
      12,     0,     9,    10,     9,    30,    31,     4,    20,    16,
      13,    16,    16,    13,    17,     8,    28,    17,    11,    12,
      32,    14,    11,    12,    15,    14,     9,     8,    17,     5,
       6,     7,     9,     9,     6,     7,     6,     9,    11,    12,
       8,    14,     8
};
...
{
       0,     4,    19,     6,     7,     9,    20,    21,     0,    16,
       9,    16,    15,     5,    21,     9,    22,     8,     9,    10,
      16,    23,    24,    25,    24,    13,    17,    24,    13,    17,
      11,    12,    14,     8,     9,     8,    17,    24,     8,    25,
      25,    24
};
...
/* Line 1455 of yacc.c  */
#line 56 "parser.y"
    {EscribirATabla((yyvsp[(1) - (4)].id), (yyvsp[(3) - (4)].cte));;}
    break;
